...
/* ==========================================================================================
   CALL RECORDINGS SECTION — FULL UPDATED VERSION
   Design System Applied: Playfair Display + DM Sans, #78ffb4 accent, orb backgrounds,
   framer-motion animations, responsive grid, premium modal
========================================================================================== */
...
export default function CallRecordingSection() {
  ...
  return (
    <section className="call-recordings-section">
      {/* Background orbs */}
      <div className="cr-orb cr-orb--tl" />
      <div className="cr-orb cr-orb--br" />

      {/* ── INTRO ── */}
      <motion.div
        className="call-recordings-intro"
      ...
      >
        {/* Eyebrow label */}
        <div className="cr-eyebrow">Live Call Intelligence</div>

        <h2 className="cr-heading">
          Every Call Is a<br />
          <span className="cr-heading-accent">Revenue System</span>
        </h2>

        <p className="cr-body">
          These recordings demonstrate how buyer and seller inquiries are
          qualified, captured, and converted — automatically. Each scenario
          represents real commission pipeline that most agencies surrender to
          slow response times and missed calls. This is your compounding
          infrastructure working 24/7.
        </p>
      </motion.div>
      ...
      <div className="recordings-grid">
        {recordings.map((rec, index) => (
          ...
          >
            {/* Top gradient line */}
            <div className="recording-card__top-line" />
          ...
          >
            ...
            >
              ...
              <img
                ...
                alt={activeRecording.shortTitle}
              />
